...
myHeaders.append("X-RapidAPI-Key", "c5c4430e76msh1879a9b94f0249ap19c967jsn5c0244c8d607");
...
placeTag.innerText = "Place-of-birth:" + result.heros[i].data.biography["place-of-birth"];
intelTag.innerText = "Intelligence: " + result.heros[i].data.powerstats.intelligence;
strengthTag.innerText = "Strength: " + result.heros[i].data.powerstats.strength;
speedTag.innerText = "Speed: " + result.heros[i].data.powerstats.speed;
durabilityTag.innerText = "Durability: " + result.heros[i].data.powerstats.durability;
